...
function HomePage() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_5__["Container"], {
    ...
    if (data) {
      var _result = data.allProducts.map(function (product) {
        return __jsx("h1", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 80
    ...
    return __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, result);
...
//# sourceMappingURL=[seller].js.01e2b86b9a4d820fec3a.hot-update.js.map