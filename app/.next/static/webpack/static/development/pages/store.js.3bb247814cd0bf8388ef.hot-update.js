...
function createKetQuas(_ref) {
  ...
  return __jsx(_material_ui_core_Paper__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    __self: this
  }, (products === null || products === void 0 ? void 0 : products.length) ? products.map(function (product, index) {
    return __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_16__["TableRow"], {
      key: product.id,
      __source: {
        fileName: _jsxFileName,
      ...
      onChange: function onChange(event) {
        var newP = products.slice();
        newP[index].sale = event.target.value;
        setProducts(newP);
      },
      InputProps: {
...
//# sourceMappingURL=store.js.3bb247814cd0bf8388ef.hot-update.js.map