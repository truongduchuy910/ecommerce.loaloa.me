...
/* harmony import */ var _utils_getGraphUri__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("iiV7");
...
Logout.getInitialProps = async ctx => {
  let data = await Object(graphql_request__WEBPACK_IMPORTED_MODULE_1__["request"])(Object(_utils_getGraphUri__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(ctx), `mutation {
    unauthenticateUser {
      success
    }
  }`);
